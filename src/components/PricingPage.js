...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .pr-promise-text { font-size: 14px; font-style: italic; color: #7a6050; line-height: 1.7; }
...
const packages = [
  ...
  },
  {
    ...
    features: [
      { text: "Our in-depth naming questionnaire — richer and more detailed than the standard form" },
      ...
      { text: "Sibling harmony and middle name consideration included" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Continued communication by email until your name is decided — no fixed end date" },
      { text: "Sibling harmony, middle name, and surname flow all considered" },
      { text: "A personal naming letter — the story of how your child's name was found, yours to keep" },
    ],
    btn: "pr-btn-outline",
      ...
      <div className="pr-wrap">
        ...
        <section className="pr-hero">
          ...
          <p className="pr-hero-sub">
            Each path leads to the same place — a name that is entirely, unmistakably yours.
          </p>
        </section>

        <div className="pr-intro">
          <p>
            We believe every family deserves to find the right name — whether you need
          ...
          <div className="pr-free-inner">
            <div>
              ...
              <div className="pr-free-desc">
                ...
                and is the first step for every family, whichever path they choose.
          ...
          {packages.map((pkg) => (
            ...
            >
              ...
              <div className="pr-card-footer">
                <button className={`pr-btn ${pkg.btn}`} onClick={() => setCurrentPage('form')}>
                  {pkg.btnText} →
                </button>
              </div>
            </div>
        ...
        <div className="pr-bespoke">
          ...
          <div className="pr-bespoke-body">
            ...
            <span style={{ color: "#8b1a1a" }}>hello@thewhisperedkin.com</span>.
